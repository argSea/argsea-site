// Postcard stamp/postmark renderer, recreated from the admin design's
// renderStamp code. Rect stamps: solid border, motif or text, optional cents
// label in the corner. Circle postmarks: dashed border with wrapped text or a
// motif. Absent stamps fall back to the design default.
...
/** The stamp as it will actually render: default applied, ink whitelisted. */
export function resolveStamp(stamp: StampData | null | undefined): StampData {
	const base = stamp ?? DEFAULT_STAMP;
	return VALID_INKS.includes(base.ink) ? base : { ...base, ink: '#f0d9a8' };
}
