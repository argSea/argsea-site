...
// the ledger, watch, and manifest sets ratified at the voice pass
// (2026-07-17)); a poke never repeats the quip currently on screen. An
// unknown context falls back to the roaming header set.
